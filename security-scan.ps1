param(
    [string]$ArtifactUrl = 'https://kaifa.zhenganhuo.com/token-rank/dl/validation/v0.5.19/73414814b38ae161c1c14c401d28f6e695673eecddacdf35cfd388339dceed01/token-rank.exe',
    [string]$ExpectedSha256 = '73414814b38ae161c1c14c401d28f6e695673eecddacdf35cfd388339dceed01'
)

$ErrorActionPreference = 'Stop'
[Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
$Root = Join-Path $env:RUNNER_TEMP 'token-rank-security-scan'
$Bin = Join-Path $Root 'token-rank-0.5.19-candidate.exe'
